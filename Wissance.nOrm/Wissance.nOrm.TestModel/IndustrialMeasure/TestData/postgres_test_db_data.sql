INSERT INTO public.physical_values(id, name, designation, description) VALUES (1, 'Температура', 'T', 'Температура');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (2, 'Давление', 'P', 'Давление');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (3, 'Объем', 'V', 'Объем');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (4, 'Сила тока', 'I', 'Сила тока');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (5, 'Электрическое напряжение', 'U', 'Электрическое напряжение');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (6, 'Масса', 'm', 'Масса');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (7, 'Частота', 'f', 'Частота');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (8, 'Плотность', 'ρ', 'Плотность');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (9, 'Длина', 'L', 'Длина');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (10, 'Электрическое сопротивление', 'R', 'Электрическое сопротивление');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (11, 'Вязкость', 'υ', 'Вязкость');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (12, 'Теплоемкость', 'C', 'Теплоемкость');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (13, 'Время', 'ts', 'Время');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (14, 'Скорость', 'Vs', 'Скорость');
INSERT INTO public.physical_values(id, name, designation, description) VALUES (15, 'Ускорение', 'a', 'Ускорение');

INSERT INTO public.measure_units(id, name, designation, description, physical_value_id)
